...
export default function ContactPage() {
  ...
  const CONTACTS = [
    { key: "email",     label: c.labels.email,     value: "support@gavanti.org", href: "mailto:support@gavanti.org" },
    { key: "instagram", label: c.labels.instagram,  value: "@chakana.ec",          href: "https://instagram.com/chakana.ec" },
    { key: "twitter",   label: c.labels.twitter,    value: "@chakana_ec",          href: "https://x.com/chakana_ec" },
    { key: "whatsapp",  label: c.labels.whatsapp,   value: "+593 939015762",        href: "https://wa.me/593939015762" },
  ] as const;
