...
<body style="margin:0;padding:0;background:${background};color-scheme:light only;">
...
<table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
  ...
  <tr>
    <td style="background:linear-gradient(160deg,#1A0F0D 0%,#2C1410 45%,#1C2E2D 100%);border-radius:12px 12px 0 0;padding:40px 40px 32px;text-align:center;">
      ...
      <p style="margin:0;font-size:26px;font-weight:700;font-family:Arial,sans-serif;letter-spacing:-0.01em;"><span style="color:#F5EDE8 !important;text-decoration:none !important;">Ya estás en la lista.</span></p>
    </td>
  </tr>
